            ...
            <div className="entryStart">
                ...
                <div className="eTitle">
                    <div className="mainTitle">
                        <p>{this.props.title}<span className="tagBug">{this.props.tag}</span></p>
                    </div>
                    <div className="subTitle">
                        <p># {this.props.entered * 3} opened on {this.props.date} by {this.props.author}</p>
                    </div>
                </div>
            </div>
...
function FullList (props) {
    var listEntries = [];
            ...
            console.log(entries.numComments);
            ...
            if (sortComment === true){
                ...
                entries['numComments'].sort((a,b) => (a.numComments < b.numComments) ? 1 : -1);
            } else if(sortLikes === true) {
                entries.numLikes.sort((a,b) => (a.numLikes < b.numLikes) ? 1 : -1);
            } else if (sortComment === false && sortLikes === false){
                console.log(props.entered)
                props.entered.sort((a,b) => (a.entered > b.entered) ? 1 : (a.entered > b.entered) ? -1 : 0);
            }
        ...
        return(          
            ...
            {/*                    ----------------------- List Sorting  -------------------------                   */}
                  <div className="listHeader">
                      <div id="listStart">
                          <div id="authorSort">
                              <p onClick={this.handleFormChange}>Author</p>
                          ...
                          <div id="mainSort">
                              ...
                              <div className="dropDownMenu">
                                <ul>
                                    ...
                                    <li id="likesListSort" ><img alt="closed" src={require ("./Icons/Closed.svg")} />Comments</li>
            ...
            {/* This call upon the completed list we created in our function earlier in this script              */}
                  <FullList numentries={this.state.entries} />
